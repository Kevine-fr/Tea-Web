...
export const adminApi = {
  ...
  // ── Période de jeu ──────────────────────────────────────────
  gamePeriod:       ()     => get('game-period').then(r => r.data ?? r),
  createGamePeriod: (body) => post('admin/game-period', body).then(r => r.data ?? r),
  updateGamePeriod: (body) => put('admin/game-period', body).then(r => r.data ?? r),
  deleteGamePeriod: ()     => del('admin/game-period'),
}