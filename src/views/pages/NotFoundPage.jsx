    ...
    <Layout>
      <div style={{
        ...
        <div className="card fade-up" style={{
          padding: '3.5rem 3rem', maxWidth: 620, width: '100%',
          textAlign: 'center', position: 'relative', zIndex: 1, borderRadius: 20,
        }}>
          <p style={{ fontWeight: 700, fontSize: '0.9rem', color: 'var(--text-muted)', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '0.6rem' }}>
            Oups... 404
          </p>
          ...
          <img
            ...
            alt="404 tea"
            style={{ width: 170, margin: '0 auto 1.5rem', objectFit: 'contain' }}
